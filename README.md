...
`outputFilePrefix`|String|prefix of output file
`runMutect2.refFasta`|String|Path to reference FASTA file
`runMutect2.refFai`|String|Path to index of reference FASTA file
`runMutect2.refDict`|String|Reference sequence dictionary file.
`mergeVCFs.refFasta`|String|Path to reference FASTA file
`filter.refFasta`|String|Path to reference FASTA file
`filter.refFai`|String|Path to index of reference FASTA file
`filter.refDict`|String|Reference sequence dictionary file.
...
`normalBai`|File?|None|Index for normalBam
